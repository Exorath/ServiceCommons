...
public interface TableNameProvider {
    ...
    /**
     * Gets a new instance of {@link TableNameProvider} that loads the tableName from a AWS_TABLE_NAME environment variable.
     * If no AWS_TABLE_NAME is provided an {@link IllegalStateException} exception will be thrown.
     * @return Environment specified {@link TableNameProvider}
     */
    static TableNameProvider getEnvironmentTableNameProvider(){
        return new EnvironmentTableNameProvider("AWS_TABLE_NAME");
    }
